public class Fuhrpark{
	...
	//Personenbef�rderung mit Elektromotor
	private List persE = new List();
	//Personenbef�rderung mit Verbrennungsmotor
	private List persV = new List();
	//Lastenbef�rderung mit Elektromotor
	private List lastE = new List();
	//Lastenbef�rderung mit Verbrennungsmotor
